...
trait VideoConsultation {
    ...
    public function onAppointmentApprove($appointment){
        ...
        if($appointment->appointment_type == 'physical'){
            ...
            $doctorUrl    = 'https://clinicall.digitecglobal.com/online_consultancy/'.$url;
            $patientUrl   = 'https://clinicall.digitecglobal.com/online_consultancy/'.$doctorBaseUrl.'/'.$url;
