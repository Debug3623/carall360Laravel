...
class PatientController extends Controller
{
    ...
    {   
        ...
        $message = "Welcome to CareAll360. $doctorName has added you as a patient. Your login details are:".$n.$n."Link: $url".$n."Username: $oPatient->phone".$n."Password: $sPassword";
