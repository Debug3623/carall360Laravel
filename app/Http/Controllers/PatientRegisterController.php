...
class PatientRegisterController extends Controller
{
    ...
    {   
       ...
       // $url = 'https://clinicall.digitecglobal.com//'.'doctor/'.$oPatient->doctor->url;
        $message = "Welcome to clinicall has added you as a patient. Your login details are:".$n.$n.$n."Username: $oPatient->phone".$n."Password: $sPassword";
    ...
    public function allDoctors(){
            ...
            $oDoctors = Doctor::where('is_active',1)->orderByDesc('updated_at')->get();
