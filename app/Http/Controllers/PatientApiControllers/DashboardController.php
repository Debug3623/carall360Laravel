...
class DashboardController extends Controller
{
    ...
    public function appointments(Request $request)
    {
       ...
       // $oQb = Appointment::orderByDesc('updated_at')->where("patient_id",$patient_id)->with(['slotId','centerId','treatmentId','patientId','doctorId','MedicalRecord','createdBy','updatedBy','deletedBy','restoredBy']);
