        ...
        if($request->hasFile('record')){
            ...
            foreach ($oFiles as $oFile) {
                ...
                if($extension == "png" || $extension == "jpg" || $extension == "jpeg"){
                    ...
                    $mPutFile = 'medical_record/'.md5($oInput['patient_id']).'/'.md5($imageNameDate).'.'.$extension;
                    $image = Storage::disk('local')->put($mPutFile,$img->encode());

                }else{
                    $mPutFile = Storage::disk('local')->putFile('medical_record/'.md5($oInput['patient_id']), $oFile);
                }
                ...
                $oMedicalrecord = MR::create([
                    ...
                    "is_active"      => isset($oInput['is_active'])?$oInput['is_active']:1,
...
/**
    ...
    public function delete($id)
    {
    	...
    	$bFileRemove = Storage::disk('local')->delete(decrypt($oMedRec->url)); 
